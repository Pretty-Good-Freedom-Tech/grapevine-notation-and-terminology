...
- add each follow to R_0, where r = { rater: seedUser, ratee: followedUser, score = 1, confidence = 0.05 }
- add each mute to R_0, where r = { rater: seedUser, ratee: mutedUser, score = 0, confidence = 0.1 }
